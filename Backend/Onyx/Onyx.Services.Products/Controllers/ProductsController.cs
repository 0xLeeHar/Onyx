...
public class ProductsController(IBus bus, IProductsRepository repository) : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ActionResult<IEnumerable<Product>>> Get([FromQuery] string? colour, CancellationToken cancellationToken)
    {
    ...
    {   
        var resourceId = Guid.NewGuid(); //Note: This could be generated by an ID creation service.
